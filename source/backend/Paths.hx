...
class Paths
{
	...
	static public function customBiosTxt(key:String, ?library:String)
		{
			return getPath('customBios/$key.txt', TEXT, library);
		}

	static public function devLockPath(key:String, ?library:String)
		{
			return getPath('mods/devLock/$key.txt', TEXT, library);
		}

	static public function customMenusTxt(key:String, ?library:String)
		{
			return getPath('customMenus/$key.txt', TEXT, library);
		}

	static public function customMenusJson(key:String, ?library:String)
		{
			return getPath('customMenus/$key.json', TEXT, library);
		}
