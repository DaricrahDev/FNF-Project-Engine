...
class SaveVariables {
	...
	public var creditsType:String = "Bios Menu";
	public var menuType:String = 'Project Engine';
	public var autoResizeImg:Bool = true;
	...
	public var spookymonth:Bool = false; 
...
class ClientPrefs {
	...
	public static function loadPrefs() {
		...
		if(Main.fps_mem != null) {
			Main.fps_mem.visible = data.showFPS;
		}
