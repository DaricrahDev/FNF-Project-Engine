...
class TitleState extends MusicBeatState
{
	...
	override public function create():Void
	{
		...
		#if html5
		FlxG.log.warn("Uh Oh, HTML5 fake build detected!");
		MusicBeatState.switchState(new WebWarning());
		#end
	...
	function startIntro()
	{
		...
		ngSpr = new FlxSprite(0, FlxG.height * 0.52).loadGraphic(Paths.image('engineLogo'));
		add(ngSpr);
		ngSpr.visible = false;
